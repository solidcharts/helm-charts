...
```shell
helm upgrade --install thanos oci://ghcr.io/solidcharts/helm-charts/thanos --version 0.12.0
```
...
helm repo update
helm upgrade --install thanos solidcharts/thanos --version 0.12.0
```
...
| image.tag | string | `"v0.42.0"` | Image tag version (if not specified, it will use the chart appVersion) |
