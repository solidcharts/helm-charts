...
![Version: 0.12.2](https://img.shields.io/badge/Version-0.12.2-informational?style=flat-square)  ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  ![AppVersion: v0.42.4](https://img.shields.io/badge/AppVersion-v0.42.4-informational?style=flat-square)  [![Artifact Hub](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/solidcharts)](https://artifacthub.io/packages/search?repo=solidcharts)
...
```shell
helm upgrade --install thanos oci://ghcr.io/solidcharts/helm-charts/thanos --version 0.12.2
```
...
helm repo update
helm upgrade --install thanos solidcharts/thanos --version 0.12.2
```
...
| bucketweb.nameOverride | string | `nil` | If set, overrides the name of the component and labels. |
...
| compactor.nameOverride | string | `nil` | If set, overrides the name of the component and labels. |
...
| image.tag | string | `"v0.42.4"` | Image tag version (if not specified, it will use the chart appVersion) |
...
| query.nameOverride | string | `nil` | If set, overrides the name of the component and labels. |
...
| queryFrontend.nameOverride | string | `nil` | If set, overrides the name of the component and labels. |
...
| ruler.nameOverride | string | `nil` | If set, overrides the name of the component and labels. |
